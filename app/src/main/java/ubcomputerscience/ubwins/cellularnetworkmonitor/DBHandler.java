...
public class DBHandler extends SQLiteOpenHelper
{
    ...
    private static final String schema = "CREATE TABLE cellRecords (N_LAT DATA, N_LONG DATA, F_LAT DATA, F_LONG DATA, NETWORK_PROVIDER DATA, TIMESTAMP DATA, NETWORK_TYPE DATA, NETWORK_STATE DATA, NETWORK_RSSI DATA, DATA_STATE DATA, DATA_ACTIVITY DATA)";
